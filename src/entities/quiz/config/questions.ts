...
const SecurityQuestions: QuizQuestion[] = [
  ...
  },
  {
    ...
    variants: [
      ...
      {
        variant: 2,
        title: 'Удалить подозрительные файлы и продолжить пользоваться учёткой, проверив на вирусы',
      },
      {
        variant: 3,
  ...
  },
  {
    ...
    variants: [
      ...
      },
      {
        variant: 2,
        title:
          'Мы подверглись атаке, при которой сеть заражённых устройств отправляет слишком много запросов, чтобы наша система перестала работать',
        description:
          'Ботнет — это сеть устройств, заражённых вредоносным ПО, которая используется для DDoS-атак, перегружающих системы избыточным трафиком',
      },
      {
        variant: 3,
      ...
      },
      {
        variant: 4,
        title:
          'Хакеры пытаются получить доступ к нашим внутренним данным через заражённые устройства',
      },
    ],
  },
  {
    ...
    variants: [
      {
        variant: 1,
        title:
          'Багозавр — особо злостный баг, который вылезает в самый неподходящий момент и ломает всё',
      },
      {
        variant: 2,
        title:
...
const EdrQuestions: QuizQuestion[] = [
  {
    ...
    variants: [
      ...
      },
      {
        ...
        description:
          'Песочница создаёт изолированную среду, где можно безопасно запустить подозрительные файлы, чтобы они не нанесли вреда системе.',
      },
      {
        variant: 3,
  ...
  },
  {
    ...
    variants: [
      ...
      },
      {
        variant: 3,
        title:
          'Подключить искусственный интеллект, чтобы тот сам нашёл все угрозы и быстро всё решил',
      },
      {
        variant: 4,
        title:
  ...
  },
  {
    id: 16,
    question:
      'Коллега рекомендует проверить телеметрию — «может она нам что-то подскажет». О чём он говорит?',
    correctVariant: 2,
    variants: [
      {
        variant: 1,
  ...
  },
  {
    id: 17,
    question:
      'Коллега сказал: «С XDR мы теперь видим всё, что происходит в нашей сети, и можем защититься от угроз». Что он имеет в виду?',
    correctVariant: 2,
    variants: [
      {
        variant: 1,
      ...
      },
      {
        variant: 2,
        title:
          'Это система, которая собирает данные с разных источников, анализирует их, даёт представление обо всех возможных угрозах и помогает избавиться от них',
        description:
  ...
  },
  {
    ...
    variants: [
      {
        variant: 1,
        title: 'Поставили задачу на автоматическое исполнение — алгоритм сам разберётся',
      },
      {
        variant: 2,
        title:
...
const XdrQuestions: QuizQuestion[] = [
  ...
  },
  {
    id: 24,
    question:
      'Коллега говорит: «Эта атака разнесла наш периметр, патчить такое — всё равно что чинить шину на скорости 100 км/ч». О чем речь?',
    correctVariant: 1,
    variants: [
      {
        variant: 1,
        title:
          'Атака позволила злоумышленникам проникнуть во внутреннюю сеть, и это создаёт высокий риск для дальнейших атак',
        description:
          'Попытка исправить ситуацию без остановки работы может привести к более серьёзным проблемам.',
      },
      {
        variant: 2,
        title:
  ...
  },
  {
    ...
    variants: [
      ...
      },
      {
        variant: 3,
        title:
          'Уведомляет все подключённые устройства и изолирует каждое из них до завершения анализа',
      },
      {
        variant: 4,
  ...
  {
    id: 28,
    question: 'Если вам скажут: «Этот эксплойт прошил нашу систему насквозь», то о чём речь?',
    correctVariant: 1,
    variants: [
      {
        variant: 1,
        title:
          'Атака настолько сложная, что её остановка требует кардинальных изменений в ядре системы',
        description:
  ...
  },
  {
    ...
    variants: [
      ...
      },
      {
        variant: 4,
        title:
          'Устаревший бэкап автоматически удаляется через определённое время, что стало причиной паники',
      },
    ],
  },
];
