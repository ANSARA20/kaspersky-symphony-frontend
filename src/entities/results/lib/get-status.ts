...
const statuses = {
  null: {
    title: 'Релаксик',
    description:
      'Расслаблен как пес на диване и беспечен в вопросах кибербеза. Пароль “12345”? Легко! Обновить антивирус? Да ну его! Ссылка от незнакомца с котиком на аватарке? Кликаем! Пока ты спокоен, но однажды сова может принести весточку о взломе. Так что будь осторожнее и забирай свои стикеры. Ну а тест ты всегда можешь перепройти!',
    img: Dog1,
  },
