...
export const FAQ = () => {
  ...
  return (
    <View
      vertical
      className='inner-shadow pointer-events-auto absolute left-1/2 top-1/2 max-w-[80%] -translate-x-1/2 -translate-y-1/2 overflow-hidden rounded-3xl bg-default px-4 pt-4 md:max-w-[724px] md:px-10 md:pt-10 lg:max-w-[964px]'
      items='center'
    >
      ...
      <View gap='lg'>
        <View vertical className='max-h-[60vh] overflow-y-scroll scrollbar-hide'>
